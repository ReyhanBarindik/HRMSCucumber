...
public class DashboardSteps extends CommonMethods {
	...
	public void user_see_dashboard_menu_is_displayed(DataTable dashboardMenu) {
		...
		List<String> expectedMenu = dashboardMenu.asList(); // data table dan gelen list
		List<String> actualMenu = new ArrayList<>();        // pom dan gelen list, web elementle buldugumuz
